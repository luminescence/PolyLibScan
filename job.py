...
class Job(object):
    ...
    def run(self):
        ...
        for i in xrange(start_idx,  end_idx):
            ...
            lmp_controler = lmp_control.lmp_controler(i, self.config.lmp_parameter, self.config.lmp_path, fifos=self.fifo, stoichiometry=self.config.sim_parameter['stoichiometry'])
